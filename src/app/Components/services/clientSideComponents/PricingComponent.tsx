        ...
        <div className="w-9/10 mx-auto">
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            <div className="flex items-center justify-center bg-gray-100 dark:bg-gray-800 p-1 rounded-full w-fit mx-auto">
              <button
                ...
                className={`px-6 py-3 rounded-full text-base font-semibold transition-all duration-300 ${isHourly
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6 lg:gap-8 mb-12">
            {pricingPlans.map((plan, index) => (
              <div
                key={plan.name}
                className={`relative bg-white dark:bg-gray-900 rounded-2xl lg:rounded-3xl p-6 md:p-8 shadow-lg hover:shadow-2xl dark:shadow-2xl dark:hover:shadow-primaryColor/10 transition-all duration-500 border ${plan.popular
              ...
              >
                ...
                <div className="flex justify-between items-start mb-6">
                  <div className={`px-4 py-2 rounded-full text-sm font-medium ${plan.name === 'Custom'
                  ...
                  <ul className="space-y-4">
                    {plan.features.map((item, featureIndex) => (
                      <li key={featureIndex} className="flex items-start gap-3">
                        ...
                        <span className={`text-base ${item.included
