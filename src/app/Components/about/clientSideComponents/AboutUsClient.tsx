...
const AboutUsClient = ({
  ...
  return (
    <FramerWrapper animation="fade-up" duration={0.8} delay={0.1} easing="ease-out" once>
      <div
        className="px-12 bg-white dark:bg-gray-900 transition-colors duration-300 flex flex-col py-12 lg:py-24 gap-16"
      >
        {/* Header Section */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="border-gray-200 border-1 hover:bg-gray-300 dark:border-gray-700 dark:hover:bg-gray-900 dark:bg-gray-800 rounded-2xl p-8 shadow-md transition-all duration-300 hover:scale-[1.02]">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-lg">{mission}</p>
          </div>
          <div className="border-gray-200 border-1 hover:bg-gray-300 dark:border-gray-700 dark:hover:bg-gray-900 dark:bg-gray-800 rounded-2xl p-8 shadow-md transition-all duration-300 hover:scale-[1.02]">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
              Our Vision
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-8">{cta.paragraph}</p>
          <a onClick={(e)=>{
            e.preventDefault();
